...
public class QobuzAppId {
    ...
    * Below some APP_ID  found in pubblic documentation:

    * https://github.com/Qobuz/api-documentation/#api-use-and-application-authentification-
    * public static final String APP_ID = "100000000";
    *
    * https://apigee.com/qobuz/embed/console/qobuz?v=2
